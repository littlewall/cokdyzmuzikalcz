...
const menuLinks = [
	{href: '#o-muzikalu', label: 'O muzikálu'},
	{href: '#tvurci-obsazeni', label: 'Tvůrci a obsazení'},
];
					...
					<div className={styles.socials}>
						...
						>
							<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<defs><clipPath id="clip0"><rect width="24" height="17" fill="transparent" transform="translate(0 3.5)"/></clipPath></defs>
							</svg>
						</a>
					</div>
				</div>
